...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import YAJL_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4bc5dff0-e00f-5dee-8f43-8e76277f4f7d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "YAJL", artifacts_toml) for e in artifacts["YAJL"]]
...
if best_platform === nothing
    @debug("Unable to load YAJL; unsupported platform $(triplet(platform_key_abi()))")
else
